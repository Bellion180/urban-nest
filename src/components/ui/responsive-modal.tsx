  ...
  <ResponsiveModalPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "max-sm:fixed max-sm:inset-x-0 max-sm:bottom-0 max-sm:top-auto max-sm:translate-x-0 max-sm:translate-y-0 max-sm:rounded-t-xl max-sm:border-t max-sm:data-[state=closed]:slide-out-to-bottom max-sm:data-[state=open]:slide-in-from-bottom",
        className
      )}
      {...props}
    >
