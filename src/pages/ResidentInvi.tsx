...
const ResidentInvi = () => {
  ...
  useEffect(() => {
    const loadResident = async () => {
      ...
      try {
        console.log('ResidentInvi: Loading resident from API...', id);
        const data = await residentService.getById(id);
        console.log('ResidentInvi: Loaded resident:', data);
        setResident(data);
      } catch (error) {
        console.error('ResidentInvi: Error loading resident:', error);
      }
    };
